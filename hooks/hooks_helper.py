...
# https://github.com/tensorflow/models/blob/master/official/utils/logs/hooks_helper.py
...
2) add a corresponding function that parses out necessary
parameters.
"""
...
from .metric_hook import LoggingMetricHook
from .throughput_hook import LoggingThroughputHook
